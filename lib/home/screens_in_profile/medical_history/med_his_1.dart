...
import 'med_his_2.dart';

class MedHis1 extends StatelessWidget {
  const MedHis1({Key? key}) : super(key: key);
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (context,index){
                      return  MaterialButton(
                        ...
                        height: 122,
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>const MedHis2()));
                        ...
                        child: const Column(
                          children: [
                            ...
                            Text("تم الإنتهاء : 1 / 4 / 2025",style: TextStyle(color: Colors.red,fontSize: 16),)
